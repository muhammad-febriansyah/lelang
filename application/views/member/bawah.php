...
Swal.fire(
    "Informasi",
    "Barang anda berhasil diperbarui!",
    "success"
);
</script>
<?php }  ?>
...
<?php }  ?>
<?php if($this->session->flashdata("msg") == "sudah"){ ?>
<script>
Swal.fire(
    "Informasi",
    "Kandidat sudah terpilih!",
    "warning"
);
</script>
<?php }  ?>
<?php if($this->session->flashdata("msg") == "pilih"){ ?>
<script>
Swal.fire(
    "Informasi",
    "Kandidat berhasil dipilih!",
    "success"
);
</script>
<?php }  ?>
